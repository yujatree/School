program ising_model
	...
	open(1, file='1000.input', status='old')   ! input of lattice_size, J, h
	open(2, file='/home/jina/monte_carlo/additional/data/data2', status='unknown', position='append')
...
10	      if (mod(p,10)==0) print*, p, 'th ensemble의 M: ', magnetization
