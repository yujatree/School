program ising_model
	...
	implicit none
	integer :: nseed, lattice_size, sum_of_Sj, i, j, k, l, m, n, o, sum_of_spins
	double precision :: rand, r, energy_difference, magnetization, sum_of_some_M, E, sum_of_some_E, avg_of_Sj
	integer, parameter :: rep=1000000, bin_size=10000
	...
	dir='/home/jina/monte_carlo/mean_field/one_low_temp/'
...
! Generate an initial configuration
	...
	write(10,'(100I3)', advance='no') lattice
...
! Pick a random point
	...
	do i=1, rep
	   ...
	   energy_difference=4.d0*dble(lattice(m,n))*(coupling_constant*avg_of_Sj+2.d0*h)
	   ...
	   if (mod(i,10)==0) then
	      ...
	      if (mod(i,1000)==0) print*, i, 'th magnetization: ', magnetization
...
!	      print*, i, '까지의 평균 M: ', mean_of_M(i/bin_size)
		 ...
		 if (abs(mean_of_M(i/bin_size)-mean_of_M(i/bin_size-1))<0.001) then
...
!	      write(*,*) i, 'th lattice is saved for animation!'
	      ...
	      write(11,'(100I3)', advance='no') lattice 
	   endif
