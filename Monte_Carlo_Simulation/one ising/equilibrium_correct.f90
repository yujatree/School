program ising_model
	...
	integer, parameter :: rep=100000000, bin_size=10000000
	double precision, parameter :: kt=3.d0, coupling_constant= 1.d0, h=0.d0
	...
	dir='/home/jina/monte_carlo/one_ising/animation_file/Tcmoremoremore/'
...
! Pick a random point
	...
	do i=1, rep
	   ...
	   if (mod(i,100)==0) then
	      ...
	      if (mod(i,100000)==0) print*, i, 'th magnetization: ', magnetization
