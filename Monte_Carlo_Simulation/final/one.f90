program ising_model
	...
	double precision, parameter :: kt=5.d0, coupling_constant= 1.d0, h=0.d0
...
!	open(8, file='stop_by_E', status='unknown')
	...
	dir='/home/jina/monte_carlo/final/animation/100dat_tc/'
...
! Generate an initial configuration
	...
	do i=1, lattice_size
	   do j=1, lattice_size
	      r=rand()
	      if (0.d0<=r .and. r<0.6d0) lattice(i,j)=1
	      if (0.6d0<=r) lattice(i,j)=-1    
	   enddo
	enddo
